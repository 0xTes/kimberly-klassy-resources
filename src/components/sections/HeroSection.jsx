...
export default function HeroSection({ brand }) {
  ...
  return (
    <section className="pb-24 pt-12 sm:pb-32 sm:pt-20">
      <Container>
        <div className="grid items-center gap-12 lg:grid-cols-[1.1fr_.9fr] lg:gap-20">
          <div className="order-2 text-center lg:order-1 lg:text-left">
            ...
            <p className="mx-auto mt-7 max-w-xl text-lg leading-8 text-brand/70 lg:mx-0">
              {hero.description}
            </p>
            ...
            <SocialLinks
              socials={socials}
              className="mt-10 lg:justify-start"
            />
          </div>
          ...
          <div className="order-1 flex justify-center lg:order-2">
            <div className="relative">
              <div
                aria-hidden="true"
                className="absolute inset-5 rounded-full border border-accent/35"
              />

              <Avatar
                image={identity.profileImage}
                alt={identity.profileImageAlt}
                initials="KK"
                className="relative size-64 rounded-full border-[10px] border-surface shadow-soft sm:size-80 lg:size-[28rem]"
              />
            </div>
          </div>
        </div>
